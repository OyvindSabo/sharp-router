...
test('Test extracting integer parameters from routes', () => {
  expect(
    getRouteAndParamsFromHash('#/rgb/255/0/0', ['/rgb/<r:int>/<g:int>/<b:int>']),
  ).toStrictEqual({
...
test('Test extracting integer parameters from route', () => {
  ...
  expect(
    getRouteAndParamsFromHash('#/rgb/0/255/0', ['/rgb/<r:int>/<g:int>/<b:int>']),
  ).toStrictEqual({
    route: '/rgb/<r:int>/<g:int>/<b:int>',
  ...
  expect(
    getRouteAndParamsFromHash('#/rgb/0/0/255', ['/rgb/<r:int>/<g:int>/<b:int>']),
  ).toStrictEqual({
    route: '/rgb/<r:int>/<g:int>/<b:int>',
...
test('Test extracting integer and number parameters from routes', () => {
  expect(
    getRouteAndParamsFromHash('#/rgb/255/0/0/0.3', ['/rgb/<r:int>/<g:int>/<b:int>/<a:number>']),
  ).toStrictEqual({
  ...
  expect(
    getRouteAndParamsFromHash('#/rgb/0/255/0/0.3', ['/rgb/<r:int>/<g:int>/<b:int>/<a:number>']),
  ).toStrictEqual({
    route: '/rgb/<r:int>/<g:int>/<b:int>/<a:number>',
  ...
  expect(
    getRouteAndParamsFromHash('#/rgb/0/0/255/0.3', ['/rgb/<r:int>/<g:int>/<b:int>/<a:number>']),
  ).toStrictEqual({
    route: '/rgb/<r:int>/<g:int>/<b:int>/<a:number>',
